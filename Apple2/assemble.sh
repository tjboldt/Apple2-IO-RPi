...
echo Building command firmware...
...
echo Building file access firmware...
...
echo Combining into single bin file in ../RaspberryPi/driveimage/AT28C64B.bin
cat \
...
echo Cleaning object and intermediary bin files...
rm ./*.o
